...
def create_monitoring_table():
    create_table_query = '''
    CREATE TABLE IF NOT EXISTS monitoring_data_test_ydlwcr (
...
def insert_sample_data():
    ...
    insert_query = '''
    INSERT INTO monitoring_data_test_ydlwcr (request_type, request_content, judgement_result, query_time)
    VALUES (%s, %s, %s, %s);
    '''
    conn = psycopg2.connect(**conn_params)
    cur = conn.cursor()
...
def create_partition_table():
    ...
    CREATE TABLE IF NOT EXISTS monitoring_data_partition (
        id SERIAL PRIMARY KEY,
        request_type VARCHAR(20) NOT NULL,
        request_content TEXT NOT NULL,
        judgement_result VARCHAR(10) NOT NULL,
    ...
    while start_date <= end_date:
        ...
        PARTITION OF monitoring_data_partition
